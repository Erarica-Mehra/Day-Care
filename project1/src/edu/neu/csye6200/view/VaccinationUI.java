...
public class VaccinationUI extends javax.swing.JFrame {
    ...
    private void jAddVacRectButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jAddVacRectButtonMouseClicked
        ...
        model.addRow(new Object[]{jTextFieldStudentName.getText(),jTextFieldVaccineName.getText(),
            jTextFielDosesTaken.getText(), jTextFieldTotalDosesTaken.getText(), jTextFieldLastShotDate.getText(),vaccine.getNextShotDate(),vaccine.isVaccinated()});
